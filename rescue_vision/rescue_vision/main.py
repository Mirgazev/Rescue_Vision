...
def parse_args():
    ...
    parser.add_argument('--enhance', default='auto', choices=[m.value for m in EnhancementMode])
...
def main():
    ...
    detector = BaseDetector(args.model, imgsz=args.imgsz, conf=args.conf, device=args.device)
