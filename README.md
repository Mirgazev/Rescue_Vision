...
**Кафедра:** Автоматизированных комплексных систем управления (АКСУ)
**Научный руководитель:** Волкова М. А., старший преподаватель кафедры АКСУ
...
* физический запуск пакета на роботе Unitree H1 не выполнялся; код пакета подготовлен как **проектная схема ROS 2-интеграции**;
...
МИРЭА — Российский технологический университет, Институт информационных
технологий, кафедра автоматизированных комплексных систем управления;
...
Вопросы по содержанию репозитория и тексту ВКР: `mirgazev.ma@edu.mirea.ru`.
